...
if (isset($_POST['tambah'])) {
    ...
    $query  = "INSERT INTO tbl_dosen (namaDosen, noHP) VALUES ('$namaDosen', '$noHP')";
    ...
    header("location:../view/dosen.php?msg=Data dosen berhasil ditambahkan!");
    exit;
}
?>
<!DOCTYPE html>
        ...
        <div class="bg-white/95 border border-slate-200 rounded-3xl shadow-lg overflow-hidden
            ...
            <div class="px-8 py-6 border-b border-slate-100"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-white font-extrabold text-lg leading-none">Tambah Data Dosen</h2>
            ...
            <!-- Form Body -->
            <form action="dosen.php" method="post" class="px-8 py-8">
