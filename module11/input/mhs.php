...
if (isset($_POST['tambah'])) {
    ...
    $query  = "INSERT INTO tbl_mahasiswa (npm, namaMhs, prodi, alamat, noHP)
    ...
    header("location:../view/mhs.php?msg=Data mahasiswa berhasil ditambahkan!");
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Tambah Mahasiswa — SIA</title>
    <!-- Tailwind -->
        ...
        <div class="bg-white/95 border border-slate-200 rounded-3xl shadow-lg overflow-hidden
            ...
            <div class="px-8 py-6 border-b border-slate-100"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-white font-extrabold text-lg leading-none">Tambah Data Mahasiswa</h2>
            ...
            <!-- Form Body -->
            <form action="mhs.php" method="post" class="px-8 py-8">

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">

                    <!-- NPM -->
                    <div class="flex flex-col gap-1.5">
                        <label for="npm" class="text-xs font-bold uppercase tracking-widest text-slate-400">
                            NPM
                        </label>
