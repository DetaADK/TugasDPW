...
if (isset($_POST['tambah'])) {
    ...
    $query  = "INSERT INTO tbl_matakuliah (kodeMK, namaMK, sks, jam)
    ...
    header("location:../view/matkul.php?msg=Data mata kuliah berhasil ditambahkan!");
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Tambah Mata Kuliah — SIA</title>
...
<body class="bg-slate-50 min-h-screen font-sans text-slate-800 overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <a href="../index.php" class="flex items-center gap-3 no-underline">
                <div class="w-10 h-10 rounded-2xl bg-blue-600 flex items-center justify-center
                            text-white text-lg shadow-lg shadow-blue-500/30">🎓</div>
                <div>
    ...
    <main class="relative z-10 max-w-7xl mx-auto px-6 py-10">
        ...
        <div class="flex items-center gap-2 text-sm text-slate-400 mb-6 animate-fade-up anim-d1">
            ...
            <span>/</span>
            <span class="text-slate-600 font-medium">Tambah Data</span>
        </div>
        ...
        <div class="bg-white/95 border border-slate-200 rounded-3xl shadow-lg overflow-hidden
            ...
            <div class="px-8 py-6 border-b border-slate-100"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-white font-extrabold text-lg leading-none">Tambah Data Mata Kuliah</h2>
                        <p class="text-blue-100 text-xs mt-1">Isi semua field di bawah ini</p>
                    </div>
                </div>
            </div>

            <form action="matkul.php" method="post" class="px-8 py-8">

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">

                    <!-- Kode MK -->
                    <div class="flex flex-col gap-1.5">
                        <label for="kodeMK" class="text-xs font-bold uppercase tracking-widest text-slate-400">
                            Kode Mata Kuliah
                        </label>
