        ...
        <section class="hero-gradient rounded-[32px] p-10 md:p-14 text-white bg-blue-700 shadow-2xl
            ...
            <div class="relative z-10">
                ...
                <p class="text-white/90 text-lg max-w-2xl leading-relaxed">
                    Kelola data dosen di sistem informasi akademik.
                </p>
            </div>
        </section>
        ...
        <div class="mt-6 bg-white/95 border border-slate-200 rounded-3xl shadow-lg overflow-hidden
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        <?php
                        $query  = "SELECT * FROM tbl_dosen" . $whereClause . " ORDER BY idDosen ASC";
                        ...
                        <tr class="data-row border-b border-slate-100 last:border-0">
                            <td class="px-6 py-4 font-mono text-xs text-slate-500">
                                <?php echo htmlspecialchars($data['idDosen']); ?>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="../update/dosen.php?idDosen=<?php echo urlencode($data['idDosen']); ?>"
                                    ...
                                    <a href="../delete/dosen.php?idDosen=<?php echo urlencode($data['idDosen']); ?>"
                                       onclick="return confirm('Anda yakin akan menghapus data dosen ini?')"
                                       class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold
            ...
            <div class="px-6 py-4 border-t border-slate-100 bg-slate-50/60">
                <p class="text-xs text-slate-400">
                    ...
                    echo "Menampilkan <span class='font-semibold text-slate-600'>$total</span> data dosen";
