    ...
    <main class="relative z-10 max-w-7xl mx-auto px-6 py-10">
        ...
        <section class="hero-gradient rounded-[32px] p-10 md:p-14 text-white bg-blue-700 shadow-2xl
            ...
            <div class="relative z-10">
                ...
                <p class="text-white/90 text-lg max-w-2xl leading-relaxed">
                    Kelola data mahasiswa di sistem informasi akademik.
                </p>
            </div>
        </section>
        ...
        <div class="mt-6 bg-white/95 border border-slate-200 rounded-3xl shadow-lg overflow-hidden
            ...
            <div class="px-6 py-5 border-b border-slate-100 flex flex-col sm:flex-row
                ...
                <!-- Search -->
                <form method="GET" action="mhs.php"
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-slate-100">
                            <th class="text-left px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-slate-400">NPM</th>
                            <th class="text-left px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-slate-400">Nama Mahasiswa</th>
                            <th class="text-left px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-slate-400">Prodi</th>
                            <th class="text-left px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-slate-400">Alamat</th>
                            <th class="text-left px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-slate-400">No HP</th>
                            <th class="text-center px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-slate-400">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $query  = "SELECT * FROM tbl_mahasiswa" . $whereClause . " ORDER BY npm ASC";
                        ...
                        <tr class="data-row border-b border-slate-100 last:border-0">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="../update/mhs.php?npm=<?php echo urlencode($data['npm']); ?>"
                                    ...
                                    <a href="../delete/mhs.php?npm=<?php echo urlencode($data['npm']); ?>"
            ...
            <div class="px-6 py-4 border-t border-slate-100 bg-slate-50/60">
                <p class="text-xs text-slate-400">
                    ...
                    echo "Menampilkan <span class='font-semibold text-slate-600'>$total</span> data mahasiswa";
